...
const dbPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "dev.db");
const dbUrl = `file:${dbPath}`;
// Create adapter for SQLite using libsql
...
const authOptions = {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    ...
                    console.log("[NextAuth] Admin found:", admin ? "yes" : "no");
                    if (!admin) {
                    ...
                    console.log("[NextAuth] Login successful for:", admin.username);
                    return {
                        id: admin.id,
                        name: admin.name,
    ...
    secret: process.env.NEXTAUTH_SECRET || "sakama-super-secret-key-2024",
    pages: {
        signIn: "/admin/login"
    },
    callbacks: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07bebb2b._.js.map